...
def create_app(config_name) -> Flask:
    ...
    from app.routes.recipes import bp as recipes_blueprint
    app.register_blueprint(recipes_blueprint)

    from app.routes.test_kitchen import bp as test_kitchen_blueprint
    app.register_blueprint(test_kitchen_blueprint)
